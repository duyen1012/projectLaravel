            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="analytic">
                            <a href="" class="text-primary">Tất cả
                                <span class="text-muted">()</span></a>
                            <a href="" class="text-primary">Công
                                khai<span class="text-muted">()</span></a>
                            <a href="" class="text-primary">Chờ
                                duyệt<span class="text-muted">()</span></a>
                            <a href="" class="text-primary">Vô
                                hiệu hóa<span class="text-muted">()</span></a>
                        </div>
